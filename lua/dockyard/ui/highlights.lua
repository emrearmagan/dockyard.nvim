...
local groups = {
	...
	DockyardActionRefresh = { fg = palette.blue, bold = true },
	...
	DockyardFooterText = { bg = palette.bg_soft, fg = palette.muted },
	DockyardFooterInfo = { bg = palette.bg_soft, fg = palette.blue, bold = true },
	DockyardFooterWarning = { bg = palette.bg_soft, fg = palette.yellow, bold = true },
	DockyardFooterError = { bg = palette.bg_soft, fg = palette.red, bold = true },
	DockyardFooterSuccess = { bg = palette.bg_soft, fg = palette.green, bold = true },
	DockyardFooterPending = { bg = palette.bg_soft, fg = palette.orange, bold = true },
	DockyardFooterAccent = { bg = palette.bg_soft, fg = palette.mauve, bold = true },
	DockyardFooterHelp = { bg = palette.bg_soft, fg = palette.orange, bold = true },
