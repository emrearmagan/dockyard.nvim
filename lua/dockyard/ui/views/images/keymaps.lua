...
---@param hooks { on_toggle?: fun(), on_remove_done?: fun(res: table|nil, ok: boolean), on_prune_done?: fun(res: table|nil, ok: boolean) }|nil
function M.setup(buf, notify, hooks)
	...
	vim.keymap.set("n", "P", function()
		actions.prune(function(_, ok)
			if hooks and hooks.on_prune_done then
				hooks.on_prune_done(nil, ok)
			end
		end, notify)
	end, opts)
