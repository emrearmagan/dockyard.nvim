...
local function set_statusline_items(networks, containers)
	local attached = 0
	...
	statusline.set_items({
		{
			text = string.format("%s %d", icons.network_icon("default"), #networks),
...
function M.render()
	...
	set_statusline_items(networks, containers)
end
